        ...
        if (_that._mode == 0) {
            ...
            if (windex != _that._windex) {
                if (_that._windex != -1) {
                    ...
                    console.log("Calling pause on " + _that._windex.toString());
                }
                else
                    setFirstWindex(windex);
                console.log("Calling play on " + windex.toString());
...
function startPlayingAudioForFirstWedge() { 
    document.getElementById(_firstWindex.toString()).play(); 
}
